...
/**
 * The cortana.ui.Ui class handles all user interactions for the cortana.core.Cortana chatbot. It
 * manages input reading and formatted output display, including greetings and farewells.
 */
public class Ui {
  /**
   * Returns the ASCII art logo of the cortana.core.Cortana chatbot. The art is adapted from: <a
   * href="https://patorjk.com/software/taag/">TAAG</a>.
   */
